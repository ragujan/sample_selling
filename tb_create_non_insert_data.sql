...
-- Dumping data for table sampleselling.customer: ~4 rows (approximately)
...
-- Dumping data for table sampleselling.customer_purchase: ~21 rows (approximately)
...
-- Dumping data for table sampleselling.sampleaudio: ~10 rows (approximately)
...
-- Dumping data for table sampleselling.sampleimages: ~24 rows (approximately)
...
-- Dumping data for table sampleselling.samplepath: ~24 rows (approximately)
...
-- Dumping data for table sampleselling.samples: ~24 rows (approximately)
...
-- Dumping data for table sampleselling.sampletype: ~4 rows (approximately)
...
-- Dumping data for table sampleselling.usercart: ~10 rows (approximately)
