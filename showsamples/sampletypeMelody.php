                            ...
                            <div id="beatPackDiv<?php echo $melodyID; ?>" class=" col-10 beatpackdiv  py-lg-0 py-md-0 py-0 offset-1">
                                <div class="row">
                                    <div class="col-12   audiopreviewdiv px-0 pt-4 pb-1 ">
                                        <audio hidden style="display:none;" id="audio<?php echo $melodyID ?>" class="audiopreviewImage">
                                            <source style="display:none;"  hidden src="<?php echo $audioPath; ?>" type="audio/ogg">
                                            <source style="display:none;"  hidden src="<?php echo $audioPath; ?>" type="audio/mpeg">
