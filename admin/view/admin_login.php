                ...
                <div class="row ">
                    ...
                    <div>
                        <div class="col-12 d-flex flex-column py-3">
                            <span>Email</span>
                            <input id="email" type="text" class="w-100 px-2 py-2 ">
                        </div>
                        <div class="col-12 d-flex flex-column py-3">
                            <span>Password</span>
                            <input type="text" id="password" class="w-100 px-2 py-2">
                        </div>
                        <div class="text-end py-3">
                            <button id="loginbtn" class="px-3 py-2   loginButton">Log in</button>
                        </div>
                    </div>
                </div>
            </div>
