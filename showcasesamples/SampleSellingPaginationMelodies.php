...
if (isset($_POST["PG"]) && isset($_POST["SSTN"])) {
    ...
    $manualQuery = "WHERE subsampletype.sampleTypeID='1' LIMIT 8 OFFSET $outputpage";
} else {
    $A = 0;
                    ...
                    <div class="col-6 offset-3">
                        <div class="row">
                            <div class="col-2  text-center d-grid ">
                                <button id="prev" class=" nextButton" onclick="nextfunctionmelody('<?php echo $realreceivednumber  - 1; ?>','<?php echo $subsampletypenumber; ?>');">Prev</button>
                            </div>
                            <div class="col-8">
                                <?php
                                for ($i = 0; $i < $stopnumber; $i++) {
                                ?>
                                    <button id="prev" class=" nextButton" onclick="nextfunctionmelody('<?php echo ($i); ?>','<?php echo $subsampletypenumber; ?>');"><?php echo ($i ); ?></button>
                            ...
                            <div class="col-2  text-center  d-grid">
                                <button id="next" class=" nextButton" onclick="nextfunctionmelody('<?php echo $realreceivednumber  + 1; ?>','<?php echo $subsampletypenumber; ?>');"><?php echo  $realreceivednumber ; ?></button>
                            </div>
                        </div>
                    </div>
                </div>
